...
import { CreateCinemaForm } from "../create/create-cinema-form";
import type { Cinema } from "../data/schema";
import { DeleteManyCinemas } from "../delete/delete-many-cinemas-form";
  ...
  return (
    <div className="flex items-center justify-between">
      ...
      <div className="flex items-center gap-0">
        {rowChecked.length > 0 ? (
          <DeleteManyCinemas cinemas={cinemas ?? []} table={table} />
        ) : null}
